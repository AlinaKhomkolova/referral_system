...
Этот проект реализует API для авторизации по номеру телефона и инвайт-системы. Пользователь проходит авторизацию, получает уникальный инвайт-код и может активировать чужой код один раз. Также в профиле отображаются пользователи, которых он пригласил.
___
### 📋 Содержание
